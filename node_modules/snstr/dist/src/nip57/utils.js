...
exports.getLightningAddressUrl = getLightningAddressUrl;
exports.fetchLnurlPayMetadata = fetchLnurlPayMetadata;
exports.supportsNostrZaps = supportsNostrZaps;
exports.decodeLnurl = decodeLnurl;
exports.parseBolt11Invoice = parseBolt11Invoice;
exports.buildZapCallbackUrl = buildZapCallbackUrl;
exports.extractLnurlMetadata = extractLnurlMetadata;
...
function decodeLnurl(lnurl) {
    try {
        ...
        const decoded = base_1.bech32.decode(lnurl.toLowerCase(), 1023);
...
function parseBolt11Invoice(bolt11) {
    try {
        ...
        const decoded = (0, light_bolt11_decoder_1.decode)(bolt11);
