...
exports.ZAP_RECEIPT_KIND = exports.ZAP_REQUEST_KIND = exports.NostrZapClient = void 0;
exports.createZapRequest = createZapRequest;
exports.createZapReceipt = createZapReceipt;
exports.validateZapReceipt = validateZapReceipt;
exports.parseZapSplit = parseZapSplit;
exports.calculateZapSplitAmounts = calculateZapSplitAmounts;
...
// Constants
exports.ZAP_REQUEST_KIND = 9734;
exports.ZAP_RECEIPT_KIND = 9735;
/**
...
function validateZapReceipt(zapReceipt, lnurlPubkey) {
    ...
    if (zapReceipt.kind !== exports.ZAP_RECEIPT_KIND) {
        return {
            valid: false,
            message: `Not a zap receipt event: kind ${zapReceipt.kind} instead of ${exports.ZAP_RECEIPT_KIND}`,
        };
    }
    ...
    try {
        const isValid = (0, crypto_1.verifySignature)(zapRequest.id, zapRequest.sig, zapRequest.pubkey);
        if (!isValid) {
    ...
    if (zapRequest.kind !== exports.ZAP_REQUEST_KIND) {
        return {
            valid: false,
            message: `Not a zap request event: kind ${zapRequest.kind} instead of ${exports.ZAP_REQUEST_KIND}`,
        };
    }
    ...
    try {
        ...
        const parsedInvoice = (0, utils_1.parseBolt11Invoice)(bolt11);
        if (!parsedInvoice) {
        ...
        const calculatedHash = (0, crypto_1.sha256Hex)(zapRequestJson);
        // Compare the hashes
 ...
 */
function parseLnurlPayResponse(data) {
    if (!data ||
        !data.callback ||
        !data.maxSendable ||
        !data.minSendable ||
