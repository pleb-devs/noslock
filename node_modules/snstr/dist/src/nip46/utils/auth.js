...
exports.isValidAuthUrl = isValidAuthUrl;
 ...
 */
function isValidAuthUrl(url, options = {}) {
    const logger = options.logger || new logger_1.Logger({ prefix: 'auth-validator' });
    try {
        const parsed = new URL(url);
        ...
        if (options.authDomainWhitelist &&
