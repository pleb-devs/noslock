...
exports.InMemoryWebSocketServer = void 0;
exports.registerInMemoryServer = registerInMemoryServer;
exports.getInMemoryServer = getInMemoryServer;
exports.unregisterInMemoryServer = unregisterInMemoryServer;
exports.createInMemoryWebSocket = createInMemoryWebSocket;
const events_1 = require("events");
const CONNECTING = 0;
const OPEN = 1;
const CLOSING = 2;
const CLOSED = 3;
class ServerSideSocket extends events_1.EventEmitter {
    constructor(server) {
        super();
        this.server = server;
...
class InMemoryWebSocketServer extends events_1.EventEmitter {
    constructor(port) {
        super();
...
exports.InMemoryWebSocketServer = InMemoryWebSocketServer;
...
function registerInMemoryServer(requestedPort) {
...
function unregisterInMemoryServer(port) {
