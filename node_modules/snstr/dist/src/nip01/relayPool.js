...
exports.RelayPool = exports.RemoveRelayResult = void 0;
...
})(RemoveRelayResult || (exports.RemoveRelayResult = RemoveRelayResult = {}));
class RelayPool {
    ...
    normalizeRelayUrl(url) {
        const normalizedUrl = (0, relayUrl_1.normalizeRelayUrl)(url);
    ...
    addRelay(url, options) {
        ...
        if (!relay) {
            relay = new relay_1.Relay(normalizedUrl, options || this.relayOptions);
