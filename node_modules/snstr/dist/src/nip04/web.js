...
exports.NIP04DecryptionError = void 0;
...
class NIP04DecryptionError extends Error {
...
exports.NIP04DecryptionError = NIP04DecryptionError;
...
function getSharedSecret(privateKey, publicKey) {
    const sk = (0, utils_1.hexToBytes)(privateKey);
    const pk = (0, utils_1.hexToBytes)("02" + publicKey);
    const shared = secp256k1_1.secp256k1.getSharedSecret(sk, pk);
    return shared.slice(1, 33);
}
/** Encrypt message per NIP-04, returns "<base64>?iv=<base64>" */
function encrypt(privateKey, publicKey, message) {
    const keyBytes = getSharedSecret(privateKey, publicKey);
    const iv = (0, utils_1.randomBytes)(16);
    const keyWA = CryptoJS.enc.Hex.parse((0, utils_1.bytesToHex)(keyBytes));
    const ivWA = CryptoJS.enc.Hex.parse((0, utils_1.bytesToHex)(iv));
...
function decrypt(privateKey, publicKey, encryptedMessage) {
    try {
