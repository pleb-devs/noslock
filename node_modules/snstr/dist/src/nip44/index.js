...
exports.MAC_SIZE_V2 = exports.MAC_SIZE_V1 = exports.MAC_SIZE_V0 = exports.NONCE_SIZE_V2 = exports.NONCE_SIZE_V1 = exports.NONCE_SIZE_V0 = void 0;
exports.isValidPublicKeyFormat = isValidPublicKeyFormat;
exports.isValidPublicKeyPoint = isValidPublicKeyPoint;
exports.isValidPrivateKey = isValidPrivateKey;
exports.getSharedSecret = getSharedSecret;
exports.getMessageKeys = getMessageKeys;
exports.generateNonce = generateNonce;
exports.hmacWithAAD = hmacWithAAD;
...
exports.NONCE_SIZE_V0 = 32;
exports.NONCE_SIZE_V1 = 32;
exports.NONCE_SIZE_V2 = 32;
exports.MAC_SIZE_V0 = 32;
exports.MAC_SIZE_V1 = 32;
exports.MAC_SIZE_V2 = 32;
...
function pad(plaintext) {
    const unpadded = (0, utils_1.utf8ToBytes)(plaintext);
...
function isValidPublicKeyPoint(publicKey) {
    ...
    for (const prefix of prefixes) {
        try {
            secp256k1_1.secp256k1.ProjectivePoint.fromHex(prefix + publicKey);
            return true;
        }
        catch {
...
function isValidPrivateKey(privateKey) {
    ...
    try {
        ...
        secp256k1_1.secp256k1.getPublicKey(privateKey);
        return true;
    }
    catch {
        return false;
...
function getSharedSecret(privateKey, publicKey) {
    ...
    try {
        ...
        let sharedPoint;
        try {
            sharedPoint = secp256k1_1.secp256k1.getSharedSecret(privateKey, "02" + publicKey);
        }
        catch {
            // If that fails, try with '03' prefix (odd y-coordinate)
            try {
                sharedPoint = secp256k1_1.secp256k1.getSharedSecret(privateKey, "03" + publicKey);
            }
            catch {
        ...
        const salt = (0, utils_1.utf8ToBytes)("nip44-v2");
        // Return the 32-byte conversation key
        return (0, hkdf_1.extract)(sha2_1.sha256, shared_x, salt);
    }
    catch (error) {
...
function getMessageKeys(conversation_key, nonce) {
    ...
    if (nonce.length < exports.NONCE_SIZE_V0) {
        ...
        throw new Error(`NIP-44: Nonce too short for key derivation. Min expected: ${exports.NONCE_SIZE_V0}, got: ${nonce.length}`);
    }
    ...
    const keys = (0, hkdf_1.expand)(sha2_1.sha256, conversation_key, nonce, 76);
...
function generateNonce() {
    return (0, utils_1.randomBytes)(exports.NONCE_SIZE_V2); // Generate nonces for the current version (V2)
}
/**
...
function hmacWithAAD(key, message, aad) {
    if (aad.length < exports.NONCE_SIZE_V0) {
        // Allow for potentially smaller nonces from older versions.
        // This check needs to be correct for the SMALLEST valid nonce size.
        throw new Error(`NIP-44: AAD (nonce) too short. Min expected: ${exports.NONCE_SIZE_V0} bytes, got: ${aad.length}`);
    }
    // Concatenate the nonce (AAD) with the ciphertext, then calculate HMAC-SHA256
    return (0, hmac_1.hmac)(sha2_1.sha256, key, (0, utils_1.concatBytes)(aad, message));
}
/**
...
function secureWipe(buffer) {
    ...
    try {
        ...
        const randomData = (0, utils_1.randomBytes)(buffer.length);
...
function encryptV2(plaintext, privateKey, publicKey, nonce) {
    ...
    if (nonceBytes.length !== exports.NONCE_SIZE_V2) {
        throw new Error(`NIP-44 (v2): Nonce must be ${exports.NONCE_SIZE_V2} bytes, got ${nonceBytes.length}`);
    }
    ...
    const payload = (0, utils_1.concatBytes)(new Uint8Array([2]), // Hardcode version 2 for V2 encryption
 ...
 */
function encrypt(plaintext, privateKey, publicKey, nonce, // This nonce is version-specific if a version is also passed in options
options) {
    // Validate keys
    if (!isValidPublicKeyPoint(publicKey)) {
        throw new Error("NIP-44: Invalid public key format. Expected 64-character hex string.");
...
function decodePayload(payload) {
    ...
    const nonceSize = version === 0
        ? exports.NONCE_SIZE_V0
        : version === 1
            ? exports.NONCE_SIZE_V1
            : exports.NONCE_SIZE_V2;
    const macSize = version === 0 ? exports.MAC_SIZE_V0 : version === 1 ? exports.MAC_SIZE_V1 : exports.MAC_SIZE_V2;
...
function decryptV2(encryptedData, nonce, mac, privateKey, publicKey) {
    ...
    const padded = (0, chacha_1.chacha20)(chacha_key, chacha_nonce, encryptedData);
